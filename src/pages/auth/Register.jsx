      ...
      <>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 16, padding: "48px 28px", width: "100%", maxWidth: 400,
            textAlign: "center",
          }}>
            <div style={{
    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        /* Tighten further on short screens (e.g. landscape mobile) */
        @media (max-height: 700px) {
          .reg-card { padding: 20px 20px 18px !important; }
          .reg-logo-wrap { margin-bottom: 16px !important; }
        }
      `}</style>
      ...
      <div style={{
        ...
        >
          {/* Logo */}
          <div className="reg-logo-wrap" style={{ textAlign: "center", marginBottom: 28 }}>
            <div style={{
